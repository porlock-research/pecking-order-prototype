...
| BUG-020 | Client UI | Empty Stage chat — partially addressed: server-driven hints via ADR-102 |
...
| PT1-UX-008 | UX | Silver economy opaque — silver badge on $ button (ADR-102), still needs transaction history |
