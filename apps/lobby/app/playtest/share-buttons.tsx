    ...
    <div className="text-center">
      ...
      <div className="flex gap-2 justify-center flex-wrap">
        ...
        <button
          ...
          className={`${btnBase} bg-[#25D366] text-white hover:brightness-110 transition-all flex items-center gap-2`}
        >
          <WhatsAppIcon />
          WhatsApp
        </button>
        ...
        <button
          onClick={shareReddit}
          className={`${btnBase} bg-[#FF4500] text-white hover:brightness-110 transition-all flex items-center gap-2`}
        >
          <RedditIcon />
          Reddit
        </button>
