...
export const Events = {
  System: {
    ...
    PLAYER_CONNECTED: 'SYSTEM.PLAYER_CONNECTED',
  ...
  Admin: {
    ...
    UPDATE_PUSH_CONFIG: 'ADMIN.UPDATE_PUSH_CONFIG',
  },
  Social: {
    PREFIX: 'SOCIAL.',
  ...
  Pregame: {
    PREFIX: 'PREGAME.',
    REVEAL_ANSWER: 'PREGAME.REVEAL_ANSWER',
  },
  Internal: {
    ...
    START_CONFESSION_CHAT: 'INTERNAL.START_CONFESSION_CHAT',
    END_CONFESSION_CHAT: 'INTERNAL.END_CONFESSION_CHAT',
  },
  Cartridge: {
...
export const FactTypes = {
  ...
  PREGAME_PLAYER_JOINED: 'PREGAME_PLAYER_JOINED',
  PREGAME_REVEAL_ANSWER: 'PREGAME_REVEAL_ANSWER',
} as const;
